...
const AddQueries = () => {
    ...
    const handleAddQuery = (e) => {
        ...
        axios.post('https://product-recommendation-server-farhans-projects-43eb552e.vercel.app/queries', queryDetail)
            .then(res => {
        ...
        <div className='w-full flex flex-col lg:flex-row lg:items-center'>
            ...
            <div className='flex-1'>
                <form onSubmit={handleAddQuery}>
                    ...
                    <input type="submit" value="Add Query" className='mt-4 border-2 px-8 py-2 rounded-full font-semibold text-white bg-[#180d38] cursor-pointer active:scale-95 shadow-[0_4px_12px_rgba(128,0,255,0.4)] active:shadow-white' />
                </form>
            </div>
